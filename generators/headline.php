...
{
	$headline = strtoupper(base64_decode($headline));
}
...
$x = 190; 
$y = $fontsize+230;
imagettftext($image, $fontsize, -1.5, $x, $y, $fontcolor, $font, $headline);
