...
if($UserID) { $Config['Enabled'] = true ; }

// Path to user files relative to the document root.
$Config['UserFilesPath'] = '/userfiles/' . $UserID . "/" ;
...
$Config['DeniedExtensions']['File']		= array('php', 'htm', 'html', 'js', 'pl') ;
...
$Config['DeniedExtensions']['Image']	= array('bmp', 'tif', 'tiff') ;
